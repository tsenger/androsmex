...
public class MSECommand extends CommandAPDU{
	...
	public void setISChat() {
		CertificateHolderAuthorizationTemplate chat = new CertificateHolderAuthorizationTemplate(PACEOID.id_IS);
	...
	public void setSTChat() {
		CertificateHolderAuthorizationTemplate chat = new CertificateHolderAuthorizationTemplate(PACEOID.id_ST);
		chat.setAuthorization((byte)0x03);
		setCHAT(chat);
	}
